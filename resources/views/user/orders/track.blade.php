        ...
        <div class="bg-white md:rounded-2xl md:shadow-xl overflow-hidden">
            ...
            <div class="rounded-b-2xl md:rounded-none p-5 text-white shadow-lg relative overflow-hidden" 
                ...
                <div class="flex items-center justify-between mb-4">
                    <a href="{{ route('user.orders.index', $order) }}" class="inline-flex items-center text-white">
            ...
            <div class="p-5 md:p-8" style="background-color: #e8fdf3;">
                <div class="space-y-4">
                    {{-- Status Pesanan --}}
                    <div class="bg-white rounded-xl border mt-6 border-gray-200 p-5 shadow-sm track-card">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm track-card">
                    ...
                    {{-- Informasi Tambahan --}}
                    <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm track-card mb-24">
